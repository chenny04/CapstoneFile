...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#components-nav" data-bs-toggle="collapse" href="#stall1.php">
        ...
        <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="#">
              <i class="bi bi-circle"></i><span>Snack</span>
            </a>
          </li>
          <li>
            <a href="#">
              ...
              <div class="card info-card sales-card">
                ...
                <div class="filter">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                    ...
                    <li><a class="dropdown-item" href="#stall1.php">Tambayan Ni Isko</a></li>
                    <li><a class="dropdown-item" href="#">Marmell Bread</a></li>
                    <li><a class="dropdown-item" href="#">Opok's Snack House</a></li>
                  </ul>
                </div>
              ...
              <div class="card top-selling overflow-auto">
                ...
                <div class="card-body pb-0">
                  ...
                  <table class="table table-borderless">
                    ...
                    <tbody>
                      <tr>
                        <th scope="row"><a href="#"><img src="assets/img/car.jpg" alt=""></a></th>
                        <td><a href="#" class="text-primary fw-bold">Carbonara</a></td>
                        <td>$64</td>
                        <td class="fw-bold">124</td>
                        <td>$5,828</td>
                      </tr>
                      <tr>
                        <th scope="row"><a href="#"><img src="assets/img/cd.jpg" alt=""></a></th>
                        <td><a href="#" class="text-primary fw-bold">Corndog</a></td>
                        <td>$46</td>
                        <td class="fw-bold">98</td>
                        <td>$4,508</td>
                      </tr>
                      <tr>
                        <th scope="row"><a href="#"><img src="assets/img/pc.jpg" alt=""></a></th>
                        <td><a href="#" class="text-primary fw-bold">Pan Cake</a></td>
                        <td>$59</td>
